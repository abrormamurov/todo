...
function App() {
  ...
  return (
    <div className="flex items-center justify-center flex-col h-full card1">
      <div className="card2">
        {" "}
        <form onSubmit={handlSubmit} className="lg:ml-16">
          <label className="flex  mb-3 ml-1 lg:w-96 w-full md:w-72 justify-between">
            ...
            />
            <button className="btn btn-primary  bg-white  rounded-xl ">
              add
            </button>
          </label>
        </form>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="btn btn-primary  bg-white  rounded-xl"
                  >
                    Chek
                  </button>
        ...
        <p className="flex justify-end items-end lg:ml-16 -ml-8 w-96">
          <button
            className="btn btn-primary bg-white p-1 rounded-xl mt-2"
            onClick={() => {
              dispetch(allDelete());
            }}
          >
